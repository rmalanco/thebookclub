            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= Yii::$app->urlManager->createUrl(['book/view', 'id' => $book->book_id]) ?>"
                                class="btn btn-info"><i class="fas fa-eye"></i>
                            </a>
                            <a href="<?= Yii::$app->urlManager->createUrl(['book/update', 'id' => $book->book_id]) ?>"
                                class="btn btn-warning"><i class="fas fa-edit"></i>
                            </a>
                            <a href="<?= Yii::$app->urlManager->createUrl(['book/delete', 'id' => $book->book_id]) ?>"
